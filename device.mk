...
# Imsservice
PRODUCT_COPY_FILES += \
    $(DEVICE_PATH)/configs/broadcast_allowlist.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/broadcast_allowlist.xml
...
PRODUCT_COPY_FILES += \
    ...
    $(DEVICE_PATH)/configs/media_codecs_c2_sec.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_c2_sec.xml \
    ...
    $(DEVICE_PATH)/configs/media_profiles_V1_0.xml:$(TARGET_COPY_OUT_ODM)/etc/media_profiles_V1_0.xml \
...
PRODUCT_COPY_FILES += \
    $(DEVICE_PATH)/configs/libnfc-nci.conf:$(TARGET_COPY_OUT_PRODUCT)/etc/libnfc-nci.conf
...
# Properties
-include $(DEVICE_PATH)/default_prop.mk
